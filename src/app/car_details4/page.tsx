...
const page = () => {
  ...
  return (
    <div className='bg-blue-50 pb-20 '>
      <div>
        <h1 className='font-semibold text-center text-2xl underline mt-4 pt-4'>Honda Civic 2024 Price in Pakistan,Images,Reviews & <br />Specs</h1>
        
      </div>
      
      <div className='' >
        <img src="city2.jpg" alt="" className='mx-64 h-56 w-auto px-24 mt-10 ' />
      </div>
