...
const page = () => {
  ...
  return (
    <div className='bg-blue-50 pb-20 '>
      <div>
        <h1 className='font-semibold text-center text-2xl underline mt-4 pt-4'>Toyotta Corolla 2024 Price in Pakistan,Images,Reviews & <br />Specs</h1>
        
      </div>
      
      <div  >
        <img src="car2.webp" alt="" className='mx-96 h-56 w-auto px-28 mt-10 ' />
      </div>
    ...
    <Link href="/form"
    className='rounded-sm bg-blue-700 text-white h-8  text-xs w-32 hover:bg-white border border-black hover:text-blue-800  py-2 text-center'>Make Payment</Link>
    </div>
      </div>
