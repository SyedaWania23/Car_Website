...
const page = () => {
  ...
  return (
    <div className='bg-blue-50 pb-20 '>
      <div>
        <h1 className='font-semibold text-center text-2xl underline mt-4 pt-4'>Honda City 2024 Price in Pakistan,Images,Reviews & <br />Specs</h1>
        
      </div>
      
      <div className='' >
        <img src="honda-civic.jpg" alt="" className='mx-80 h-56 w-auto px-28 mt-10 ' />
      </div>
